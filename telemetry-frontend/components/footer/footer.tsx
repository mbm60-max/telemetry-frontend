        ...
        <div >
            ...
            <Box sx={{width:'102%',display:'flex',alignItems:'center',backgroundColor:'rgba(9, 27, 90,1 )'}}>
                ...
                <Grid item xs={2}  sx={{display: 'flex', justifyContent: 'end', alignItems: 'center'}} ><StyledVerticalDivider/></Grid>
                    ...
                    <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}> <Button className="basic-button"><Link style={{ color: '#F6F6F6', textDecoration: 'none' ,fontFamily:'Satoshi'}} href={"/recommended"}>Recomended</Link></Button></Grid>
