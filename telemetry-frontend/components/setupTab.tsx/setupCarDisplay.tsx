...
const SetupCarDisplay = ({ carName,setupName}: SetupCarDisplayProps) => {
  ...
  return (
    ...
    <Grid container spacing={2} >
          ...
          <Grid item xs={12}><Typography variant="h6" sx={{fontSize:36}}  fontWeight="bold">{carName}</Typography></Grid><Grid item xs={12}><Typography  variant="body2" sx={{fontSize:20}}>{setupName}</Typography></Grid></Grid></Grid><Grid item xs={8} ><Box sx={{ width:'50vw', height: '50vh',position:'relative' }}><Image
