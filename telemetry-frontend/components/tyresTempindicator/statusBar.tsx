...
const StatusBar = ({tyre,temp}:StatusBarProps) => {
    return (
      ...
      <Box sx={{ width: 120, height: 70, backgroundColor: "#1E1E1E", justifyContent:"center", display:"flex" }}><Box sx={{ width: 55, height: 70, backgroundColor: "green", mt:1}}></Box> </Box> 
