...
const ActualWarning = ({onClose,activeWarning,handleActiveWarnings,handleAcknowledgedWarnings,isHigherWarning}: ActualWarningProps) => {
  ...
  <Grid container spacing={2}><Grid item xs={12} sx={{display:'flex',justifyContent:'center'}}>  <Item><HorizontalBanner
        GridContent={[`Limit exceeded !`]}
        ...
        <Grid item xs={12} sx={{display:'flex',justifyContent:'center'}}>  <Item><HorizontalBanner
        ...
        fontSizes={[24]} needsBackground={false} fontFamilies={["Yapari"]} fontWeights={["Bold"]} fontColour={["white"]} isMutliStage={false} marginLeftValue={[]} isBannerInterface={true} /></Item></Grid>
  ...
  <Grid item xs={12}><Box sx={{height:'0px'}}></Box></Grid>
            ...
            <Grid item xs={6} sx={{display:'flex',justifyContent:'center'}} ><BoxedNumber  width={"80%"} targetAttribute={"Limit:"} targetAttributeValue={activeWarning.newWarningLimit} toolTipContent={"The current limit for the attribute"} stringValue={activeWarning.newWarningUnits} className={'textBox'}/></Grid>
               <Grid item xs={6} sx={{display:'flex',justifyContent:'center'}}><BoxedNumber width={"80%"} targetAttribute={"Current:"} toolTipContent={"The most recently recieved value for the attribute"}  targetAttributeValue={activeWarning.newWarningValue} stringValue={activeWarning.newWarningUnits} className={'textBox'}/></Grid>
