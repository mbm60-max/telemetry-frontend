  ...
  if (req.method === 'GET') {
    ...
    try {
      ...
      if (userDocument) {
        ...
        res.status(200).json({ pfpSVG20: userDocument.pfpSVG20,pfpSVG40: userDocument.pfpSVG40,pfpSVG60: userDocument.pfpSVG60});
      } else {
        // User with the matching username not found 
        console.error('User not found');
        res.status(200).json({ pfpSVG20: "", pfpSVG40: "", pfpSVG60: ""});
      }
