...
import { TextField, Button, Divider, Grid, styled, Paper, Box, FormControl, InputLabel, MenuItem, Select, SelectChangeEvent } from '@mui/material';
  ...
  return (
    <>
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100vh" }}>
        <div style={{ justifyContent: "center", display: "flex", backgroundColor: "#F6F6F6", height: "610px", width: 1000 }}>
          <div style={{ marginTop: 25 }}>
            <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
        <Grid item xs={6}>
          <Item><QuickFilteringGrid onSelectCar={handleCarSelection} /></Item>
        </Grid>
        <Grid item xs={6}>
        <Item><TrackSelectionModal onSelectTrack={handleTrackSelection}/><ImageBox
        Width={'400px'}
        Height={'350px'}
        MarginRight={'0px'}
        MarginLeft={'0px'}
      ...
      /></Item>
        ...
        <Grid item xs={6}>
        <ItemCentered><Box sx={{ minWidth: '100%' }}>
      <FormControl fullWidth>
        ...
        <Grid item xs={6}>
              ...
              <div>{selectedCar}{compound}{selectedTrack}</div>
              <Button type="submit" variant="contained" sx={{ mr: 2, width: "167px" }}>
                Submit
              </Button>
            </form>
          </div>
