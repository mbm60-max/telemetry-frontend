...
const  getFuelOnConsumptionByRelativeFuelLevels=(fuelObject:fuelConsumptionObject,lastLapTime:number)=>{
    let i = -5;
    ...
    while (i <= 5){
        ...
        relativeFuelMap.lapsRemainingOnCurrentFuel = fuelObject.lapsRemaining + fuelObject.lapsRemaining * (
